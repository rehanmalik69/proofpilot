  ...
  return (
    <div className="mx-auto flex w-full max-w-[88rem] flex-col gap-7 px-5 pb-14 pt-6 sm:px-8 sm:pb-16 sm:pt-8 lg:gap-8 lg:px-10">
      ...
      <section className="surface-strong overflow-hidden rounded-[2rem] border border-white/80">
        <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[minmax(0,1.12fr)_minmax(20rem,0.88fr)] lg:gap-8 lg:p-10">
          <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
              <div className="rounded-[1.5rem] border border-slate-200/80 bg-slate-50/85 p-5">
                <Landmark className="size-5 text-slate-950" />
                <div className="mt-4 text-sm text-slate-500">Merchant</div>
                <div className="mt-1 text-lg font-semibold text-slate-950">{caseItem.merchant_name}</div>
              </div>
              <div className="rounded-[1.5rem] border border-slate-200/80 bg-slate-50/85 p-5">
              ...
              <div className="rounded-[1.5rem] border border-slate-200/80 bg-slate-50/85 p-5">
                <CalendarDays className="size-5 text-slate-950" />
                <div className="mt-4 text-sm text-slate-500">Incident date</div>
                <div className="mt-1 text-lg font-semibold text-slate-950">
              ...
              <div className="rounded-[1.5rem] border border-slate-200/80 bg-slate-50/85 p-5">
                <FileText className="size-5 text-slate-950" />
                <div className="mt-4 text-sm text-slate-500">Created</div>
                <div className="mt-1 text-lg font-semibold text-slate-950">
      ...
      <section className="grid gap-6 xl:items-start lg:grid-cols-[minmax(0,0.84fr)_minmax(0,1.16fr)]">
